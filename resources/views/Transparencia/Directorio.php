...
<table align="center" cellspacing="4" class="table table-responsive">
  ...
  <tr>
    ...
    <?php 
      ...
      <td align="center"><a href="../Transparencia/EliminarDirectorio.php?ruta=<?php echo $mostrar['ruta']?>"><i class="fas fa-trash-alt" style="color: red;"></i></a>
      </td>
      <?php
      }
     ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="AgregarDirectorio.php" method="post" enctype="multipart/form-data">

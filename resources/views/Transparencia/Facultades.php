...
<div class="row" style="margin-top: 2%;margin-left: 5%;">
	...
	<div style="height: 100%;
		...
		<div class="col-md-16" style="margin-left: 15%;margin-top:5%;">
			<?php
		$sql="SELECT * from facultades order by id desc";
...
<table align="center" cellspacing="4" class="table table-responsive">
	...
	<tr>
		...
		<td align="center"><a href="../Transparencia/upload/<?php echo $mostrar['ruta']?>"><i class="fas fa-download" style="color: #2ECC71;"></i></a>
		</td>
		<?php 
			if ($estado ==true) {
			...
			<td align="center"><a href="../Transparencia/EliminarFacultades.php?ruta=<?php echo $mostrar['ruta']?>"><i class="fas fa-trash-alt" style="color: red;"></i></a>
			</td>
			<?php
			}
		 ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="AgregarFacultades.php" method="post" enctype="multipart/form-data">

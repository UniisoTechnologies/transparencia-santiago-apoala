...
<div class="row" style="margin-top: 2%;margin-left: 5%;">
	...
	<div style="height: 100%;
		...
		<div class="col-md-5" style="margin-top: 2%;margin-left: 25%;">
			<h4>INDICADORES PÚBLICOS</h4>
		</div>
		

		<div class="col-md-16" style="margin-left: 15%;margin-top:5%;">
			<?php
		$sql="SELECT * from indicadorespublicos order by id desc";
...
<table align="center" cellspacing="4" class="table table-responsive">
	...
	<tr>
		...
		<?php 
			...
			<td align="center"><a href="../Transparencia/EliminarIndicadoresPublicos.php?ruta=<?php echo $mostrar['ruta']?>"><i class="fas fa-trash-alt" style="color: red;"></i></a>
			</td>
			<?php
			}
		 ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="AgregarIndicadoresPublicos.php" method="post" enctype="multipart/form-data">

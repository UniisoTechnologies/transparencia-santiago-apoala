...
<div class="row" style="margin-top: 2%;margin-left: 5%;">
	...
	<div style="height: 100%;
		...
		<div class="col-md-16" style="margin-left: 15%;margin-top:5%;">
			<?php
		$sql="SELECT * from metasyobjetivos order by id desc";
...
<table align="center" cellspacing="4" class="table table-responsive">
	...
	<tr>
		...
		<?php 
			...
			<td align="center"><a href="../Transparencia/EliminarMetas.php?ruta=<?php echo $mostrar['ruta']?>"><i class="fas fa-trash-alt" style="color: red;"></i></a>
			</td>
			<?php
			}
		 ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="AgregarMetas.php" method="post" enctype="multipart/form-data">
